...
class MCPConfigurationManager:
    ...
    def _add_default_servers(self):
        default_servers = [
            MCPServerConfig(name="github", url="ws://localhost:3000", description="GitHub MCP Server for repository operations", enabled=False, auto_connect=False),
            MCPServerConfig(name="filesystem", url="ws://localhost:3001", description="Filesystem MCP Server for file operations", enabled=False, auto_connect=False),
            MCPServerConfig(name="weather", url="ws://localhost:3002", description="Weather MCP Server for weather information", enabled=False, auto_connect=False)
        ]
